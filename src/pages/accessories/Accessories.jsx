...
import { accessoriespage } from "../../assets/Export";
...
function Accessories() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    apiFetch(
      `/products?page=${currentPage}&limit=${productsPerPage}&category=accessories`,
    )
      .then((data) => {
        if (!active) return;
      ...
      .catch((e) => console.error("Error fetching accessories:", e))
      ...
      <section className="page-hero">
        ...
        <div className="page-hero-content">
          ...
          <p className="page-tagline">
            Handcrafted essentials — where every detail is a deliberate act of
            refinement.
          </p>
        </div>
      </section>
